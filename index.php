...
<div class="slider-area">
    <div class="bend niceties preview-1">
        <div id="ensign-nivoslider" class="slides">
            <img src="img/slider/banner1.jpg" alt="" title="#slider-direction-1" />
            <img src="img/slider/HPcover.jpg" alt="" title="#slider-direction-2" />
            <img src="img/slider/game.png" alt="" title="#slider-direction-2" />
        </div>
        <!-- direction 1 -->
...
<div class="online-banner-area">
    <div class="container">
        <div class="banner-title text-center">
            ...
            <p>The Online Books Guide is the biggest big store and the biggest books library in the world that has
            ...
            <div class="banner-list">
                <div class="col-md-4 col-sm-6">
                    <div class="single-banner">
                        <a href="#">
                            <img src="img/banner/abc.jpg"abc.jpg" alt="">
                        </a>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-banner">
                        <a href="#">
                            <img src="img/banner/abc.jpg"2.jpg" alt="">
                        </a>
                        <div class="price"><span>$</span>160</div>
                        <div class="banner-bottom text-center">
                            <a href="#">NEW RELEASE 2016</a>
                ...
                <div class="col-md-4 hidden-sm">
                    <div class="single-banner">
                        <a href="#">
                            <img src="img/banner/abc.jpg"3.jpg" alt="">
                        </a>
                        <div class="price"><span>$</span>160</div>
                        <div class="banner-bottom text-center">
                            <a href="#">NEW RELEASE 2016</a>
